...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_login.php" method="post">
            <img class="py-3" src="assets/img/Logo.png" width="200px" >
            ...
            <a href="register.php">Belum Punya Akun? Sini Daftar</a>

            <p class="mt-5 mb-3 text-muted">&copy; <b>LDR PRIDE - Teknik Informatika <br>2022</p> </b>
        </form>
    </main>
